 ...
 * @author Author
 */
public class deep_guardianAnimation {
	public static final AnimationDefinition 攻击 = AnimationDefinition.Builder.withLength(1.0F)
	...
	public static final AnimationDefinition 待机 = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition 游泳 = AnimationDefinition.Builder.withLength(1.25F).looping()
		.addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),

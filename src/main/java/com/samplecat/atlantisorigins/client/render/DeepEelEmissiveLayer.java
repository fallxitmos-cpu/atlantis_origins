...
public class DeepEelEmissiveLayer extends RenderLayer<DeepEel, DeepEelModel> {

    private static final ResourceLocation EMISSIVE_TEXTURE = ResourceLocation.fromNamespaceAndPath(
            AtlantisOrigins.MOD_ID, "textures/entity/deep_eel_e.png");

    public DeepEelEmissiveLayer(DeepEelRenderer renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
                       DeepEel entity, float limbSwing, float limbSwingAmount,
